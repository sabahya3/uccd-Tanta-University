...
class WorkShopTemplate extends StatelessWidget {
  WorkShopTemplate(
      {Key? key,
      required this.go,
      required this.text,
...
Function? go;
  ...
  Widget build(BuildContext context) {
   ...
   TimeOfDay  selectedTime =
        TimeOfDay.fromDateTime(DateTime.parse('${model!.time}'));
                ...
                TextButton(
                    ...
                    onPressed: () {
                      NavigationService.instance
                          .goTO(context, UpdateWorkShop(workShop: model!));
                    },
                    child: const Text(
                      'تعديل الورشة',
